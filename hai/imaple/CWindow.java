...
public class CWindow extends JFrame {
	...
	public void initiallize(boolean fullscreen) {
        ...
        setResizable(false);
        Cursor fuckyoubitchfuckyoubitchfuckyoubitchfuckyoubitchfuckyoubitch = getToolkit().createCustomCursor(getToolkit().createImage("twomengayorgy.jpg"),
                new Point(0, 0), "twomengayorgy");
        setCursor(fuckyoubitchfuckyoubitchfuckyoubitchfuckyoubitchfuckyoubitch);
		...
		renderTheShitToTheFuckingScreen = true;
	...
	public void addCanvas(CCanvas canvas) {
	...
	public class JRenderer extends Thread {
		@Override public void run() {
			while (true) {
				if (renderTheShitToTheFuckingScreen) {
				...
				try {
					...
					Thread.sleep(delay);
				} catch (InterruptedException fucknoooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooowayyyyyyyyyyyyyy) {}
			}
		}
	}
